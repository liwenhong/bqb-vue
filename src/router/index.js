...
export const asyncRouterMap = [
...

  {
    ...
    children: [
      ...
      { path: 'hotData', component: _import('form/hotData'), name: 'hotData', meta: { title: 'hotData', icon: 'table' }},
      { path: 'newData', component: _import('form/newData'), name: 'newData', meta: { title: 'newData', icon: 'table' }}
    ]
  },

  {
    ...
    children: [
      { path: 'create-form', component: _import('handUpload/create'), name: 'addNewBq', meta: { title: 'addNewBq', icon: 'table' }},
      { path: 'edit-form', component: _import('handUpload/edit'), name: 'addSerieBq', meta: { title: 'addSerieBq', icon: 'table' }},
