<template>
  <div class="upload-container">
    <el-upload  class="img-upload" :data="dataObj" multiple :auto-upload="false" list-type="picture-card" name="avatar" action="https://api.doutub.com/api/file/uploadMulterToQN"
